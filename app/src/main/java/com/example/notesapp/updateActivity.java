...
public class updateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // GET NOTES ID IF THE NOTE IS EXIST
        if(notes != null){
            notesId = notes.getId();

            // SET NOTE CONTENT TO THE UPDATE PAGE
        ...
        //CALL SUBTITLE COLOR INDICATOR CHANGER
        indicatorChange();

        // CALL INIT MODAL METHOD
        initmodal();
    ...
    private void showAlertDialog(){
        ...
        String dialogMessege = "Are you sure want to delete this notes?";
    ...
    private void initmodal(){
        final LinearLayout layoutmodal = findViewById(R.id.modal);
        final BottomSheetBehavior bottomSheetBehavior = BottomSheetBehavior.from(layoutmodal);
        layoutmodal.findViewById(R.id.modal).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
