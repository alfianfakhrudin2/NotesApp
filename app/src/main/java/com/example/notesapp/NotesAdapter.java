...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.ViewHolder>{
    ...
    //Untuk menampung data dari class Notes
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.notesLayout.setOnClickListener((View v) -> {
            ...
            Toast.makeText(activity, "Press back button to save changes", Toast.LENGTH_SHORT).show();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        // GETTING THE LAYOUT ID TO AND SAVE IT TO THE VARIABLE
        ...
        // Set Bacgkround color of the card
